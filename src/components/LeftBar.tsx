...
export default function LeftBar(){
    ...
    return(
      <aside className="fixed top-14 left-0 bottom-0 w-60 bg-[#0f0f0f] p-3 hidden sm:flex flex-col gap-4 overflow-y-auto z-40 select-none border-r border-[#212121]/50 text-[#f1f1f1]">         
      {/* Main Section */}
