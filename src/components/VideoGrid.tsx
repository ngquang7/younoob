...
export default function VideoGrid () {
    ...
    >
      ...
      <div className="relative aspect-video w-100 overflow-hidden rounded-xl bg-[#212121] transition-shadow duration-300 group-hover:shadow-[0_8px_30px_rgb(0,0,0,0.5)]">
        <img
